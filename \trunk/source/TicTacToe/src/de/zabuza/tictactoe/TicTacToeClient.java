...
public class TicTacToeClient {
    ...
    private void connect(String adress) throws UnknownHostException, IOException {
        // Setup networking
    ...
    static class Square extends JPanel {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 2854939304204770402L;
